    ...
    <body>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('prodi/read/'.$prodi->No),'Read'); 
				echo ' | '; 
				echo anchor(site_url('prodi/update/'.$prodi->No),'Update'); 
				echo ' | '; 
				echo anchor(site_url('prodi/delete/'.$prodi->No),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
		...
		<?php echo anchor(site_url('prodi/excel'), 'Excel', 'class="btn btn-primary"'); ?>
	    </div>
