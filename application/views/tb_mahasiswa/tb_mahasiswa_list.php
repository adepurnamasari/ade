    ...
    <body>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('tb_mahasiswa/read/'.$tb_mahasiswa->id),'Read'); 
				echo ' | '; 
				echo anchor(site_url('tb_mahasiswa/update/'.$tb_mahasiswa->id),'Update'); 
				echo ' | '; 
				echo anchor(site_url('tb_mahasiswa/delete/'.$tb_mahasiswa->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
